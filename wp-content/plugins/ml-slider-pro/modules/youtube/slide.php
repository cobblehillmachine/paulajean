...
class MetaYouTubeSlide extends MetaSlide {
    ...
    protected function get_admin_slide() {
        ...
        $row .= "            <span class='slide-details'>" . __("YouTube", 'metasliderpro') . " - {$video_id}</span>";
        $row .= "            <span class='youtube'></span>";
        $row .= "        </div>";
        $row .= "    </td>";
        $row .= "    <td class='col-2'>";
        $row .= "        <div class='title'>" . __('Player Settings', 'metasliderpro') . "</div>";
        $row .= "        <ul class='settings'>";
        ...
        $row .= "        <ul class='theme'>";
        $row .= "            <li>";
        $row .= "                 <label><span class='label'>" . __("Theme", 'metasliderpro') . "</span>";
        ...
        $row .= "             </li>";  
        $row .= "             <li>";
        $row .= "                 <label><span class='label'>" . __("Color", 'metasliderpro') . "</span>";        
